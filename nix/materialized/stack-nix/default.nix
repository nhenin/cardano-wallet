  ...
  extras = hackage:
    {
      packages = {
        ...
        "blockfrost-api" = (((hackage.blockfrost-api)."0.5.0.0").revisions).default;
        "blockfrost-client" = (((hackage.blockfrost-client)."0.5.0.0").revisions).default;
        "blockfrost-client-core" = (((hackage.blockfrost-client-core)."0.5.0.0").revisions).default;
